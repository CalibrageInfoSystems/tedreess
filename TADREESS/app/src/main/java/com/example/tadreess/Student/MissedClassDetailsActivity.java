...
import com.example.tadreess.Student.MissedClassAdapter.MissedClassAdapter;
import com.example.tadreess.Student.MissedClassAdapter.MissedClassGetSet;
...
public class MissedClassDetailsActivity extends AppCompatActivity {
    RecyclerView recyclerview1;
    List<MissedClassGetSet> arrayList;
    MissedClassAdapter adapter;
    ProgressBar pBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missed_class_details);
    ...
    // MySchedule() ;
        ...
        recyclerview1.setLayoutManager(new GridLayoutManager(MissedClassDetailsActivity.this, 1));
    ...
    public void ClassDetails() {
        ...
        AndroidNetworking.post("http://168.187.113.181:813/TadreesService.svc/GetClassDetails?type=3&userid=" + strStudentId + "&scheduleid=" + strScheduleId + "&cultureid=1")
                        ...
                        try {
                            ...
                            if (str.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    MissedClassGetSet GetSet = new MissedClassGetSet();
                                ...
                                adapter = new MissedClassAdapter(arrayList,MissedClassDetailsActivity.this);
                                recyclerview1.setAdapter(adapter);
                                pBar.setVisibility(View.GONE);
                                Log.e("tracing", arrayList.size() + "");


                               // Toast.makeText(MissedClassDetailsActivity.this, "success" + str, Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(MissedClassDetailsActivity.this, "No details available" , Toast.LENGTH_SHORT).show();
